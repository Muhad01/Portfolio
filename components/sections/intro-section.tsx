      ...
      <div className="w-full">
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="space-y-6 max-w-md">
            ...
            {/* Mobile: horizontal social links (desktop uses fixed vertical rail) */}
            {showSocialLinks && (
              <div className="flex lg:hidden flex-wrap items-center gap-4 pt-8 border-t border-border/40 mt-8">
                <Link
                  href="https://www.linkedin.com/in/muhammad-muhad-8b1662303/"
                  target="_blank"
                  rel="noopener noreferrer"
